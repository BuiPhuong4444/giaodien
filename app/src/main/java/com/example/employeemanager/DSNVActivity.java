...
public class DSNVActivity extends Activity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dsnv);
            ...
            if(nhanViens != null) {
                ...
                ListView lst = (ListView) findViewById(R.id.lstNV);
                ...
                lst.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        ...
                        Intent intent = new Intent(DSNVActivity.this, TTinNVActivity.class);
                ...
                Toast.makeText(DSNVActivity.this,"Không có nhân viên nào",Toast.LENGTH_LONG ).show();
            }
    ...
    @Override
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        Toast.makeText(this,"Vi trí"+ position, Toast.LENGTH_LONG );
    }
}
